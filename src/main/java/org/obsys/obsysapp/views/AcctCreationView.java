...
public class AcctCreationView extends ViewBuilder implements IObsysBuilder {
    ...
    public ArrayList<Node> createLabels() {
        ...
        return new ArrayList<>(List.of(lblAcctNumInvalid, lblFirstNameInvalid, lblLastNameInvalid, lblNotFound,
                lblUsernameInvalid, lblPasswordInvalid)){{
    ...
    public ArrayList<Node> createTextFields() {
        ...
        return new ArrayList<>(List.of(txtAcctNum, txtFirstName, txtLastName, txtUsername)){{
